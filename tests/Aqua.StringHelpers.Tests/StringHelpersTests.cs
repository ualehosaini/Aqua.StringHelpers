...
namespace Aqua.StringHelpers.Tests
{
    public class StringHelpersTests
    {
        ...
        public void InNullOrEmpty_Valid(string input, bool expected) => Assert.Equal(expected, input.IsNullOrEmpty());
        ...
        public void IsAlphaNumeric_Valid(string input, bool expected) => Assert.Equal(expected, input.IsAlphaNumeric());
        ...
        public void InNumber_Valid(string input, bool expected) => Assert.Equal(expected, input.IsNumber());
        ...
        [InlineData("lorem      ipsum dolor ", "lorem ipsum dolor")]
        [InlineData("       lorem       ipsum       dolor", "lorem ipsum dolor")]
        public void ReplaceTabsWithSpaces_Valid(string input, string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        [InlineData("lorem\nipsum dolor\n", "lorem ipsum dolor")]
        public void ReplaceNewLinesWithSpaces_Valid(string input, string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        [InlineData("   lorem\nipsum  dolor\n  ", "lorem ipsum dolor")]
        [InlineData("\tlorem\nipsum    dolor\n     ", "lorem ipsum dolor")]
        public void ToCleanString_Valid(string input, string expected) => Assert.Equal(expected, input.RemoveExtraSpaces());
        ...
        public void ToHyperlink_Valid(string input, string expected) => Assert.Equal(expected, input.ToHyperlink());
        ...
        [InlineData("", "")]
        [InlineData(" ", " ")]
        public void ToUkTelephoneFormat_Valid(string input, string expected) => Assert.Equal(expected, input.ToUkTelephoneFormat());
        ...
        public void ToSummarisedTextRight_Valid(string input, int length, string expected) => Assert.Equal(expected, input.ToSummarisedTextRight(length));
        ...
        [InlineData("\tlorem\nipsum    dol\n     ", "dol")]
        public void GetFirstShortestWord_Valid(string input, string expected) => Assert.Equal(expected, input.GetFirstShortestWord());
        ...
        [Theory]
        [InlineData(null, "")]
        public void IfNullReturnEmptyString_Valid(string input, string expected) => Assert.Equal(expected, input.IfNullReturnEmptyString());
        ...
        public void GetFileExtension_Valid(string input, string expected) => Assert.Equal(expected, input.GetFileExtension());
        ...
        public void FindAllDigits_Valid(string input, string expected) => Assert.Equal(expected, input.FindAllDigits());
        ...
        [InlineData("abcd", 3, "abcd")]
        public void RightAligned_Valid(string input, int length, string expected) => Assert.Equal(expected, input.RightAligned(length));

        [Theory]
        [InlineData("abcdभारतxyz", "abcdxyz")]
        [InlineData(null, null)]
        [InlineData("", "")]
        public void RemoveNonASCIIChars_Valid(string input, string expected)
        {
        ...
        public void ReplaceDoubleQuotesWithSingle_Valid(string input, string expected)
        {
